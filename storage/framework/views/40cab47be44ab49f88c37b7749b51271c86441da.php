    ...
    <div style="font-family:Arial" class="breadcrumbs">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <ul>
                        <li class="home"><a href="<?php echo e(route('site.home.index')); ?>" title="Đi đến Trang chủ"><?php echo e(__('Trang Chủ')); ?></a> <span>/</span></li>
                        <li><strong><?php echo e(__('Giỏ Hàng')); ?></strong></li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <div class="title-tab-product-category">
                            <div class="text-center">
                                <ul class="nav jtv-heading-style" role="tablist">
                                    <li role="presentation" class="active"><a href="#cart" aria-controls="cart" role="tab" data-toggle="tab"><?php echo e(__('1. Giỏ Hàng Của Tôi')); ?></a></li>
                                    ...
                                    <li role="presentation" class=""><a href="#complete-order" aria-controls="complete-order" role="tab" data-toggle="tab"><?php echo e(__('3. Kiểm Tra Đặt Hàng')); ?></a></li>
                                </ul>
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="content-tab-product-category">
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane fade in active" id="cart">
                                    <!-- cart are start-->
                                    <?php echo $__env->make('site.error_order', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                    <h3 style="font-family:Arial">Danh sách đơn hàng của bạn</h3>
                                    <div class="cart-page-area">
                                        <form method="post" action="<?php echo e(route('site.cart.update')); ?>">
                                            <?php echo e(csrf_field()); ?>

                                            <div class="table-responsive">
                                                <table class="shop-cart-table data-cart" id="checkAll">
                                                    <thead>
                                                    <tr>
                                                    ...
                                                    <?php $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr class="cart_item row-<?php echo e($row->id); ?>">
                                                            ...
                                                            <td class="item-price" style="width:180px"><?php echo e(number_format($row->price, null, null, ".")); ?> đ</td>
                                                            <td class="item-qty">
