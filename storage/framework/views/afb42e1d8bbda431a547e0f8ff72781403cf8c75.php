            ...
            <div class="row">
                <div class="col-sm-8 col-sm-push-4 col-md-9 col-md-push-3 main-inner">
                        ...
                        <div class="jtv-featured-products">
                            <div class="slider-items-products">
                                <div class="jtv-new-title">
                                    <h2 style="font-family: Arial"><?php echo e(__('Sản phẩm mới')); ?></h2>
                                </div>
                                <div id="featured-slider" class="product-flexslider hidden-buttons">
                                    <div class="slider-items slider-width-col4 products-grid">
                                        <?php $__currentLoopData = $product_new; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="item">
                                                <div class="item-inner">
                                                    <div class="item-img">
                                                        <div class="item-img-info">
                                                            <a class="product-image" href="product-detail.html">
                                                    ...
                                                    <div class="item-info">
                                                        <div class="info-inner">
                                                            <div class="item-title">
                                                                <a title="Xem chi tiết sản phẩm" href="<?php echo e(route('product.view', ['id' => $row->id])); ?>"><?php echo e($row->name); ?></a>
                                                            </div>
                                                                ...
                                                                <div class="actions">
                                                                    <div class="add_cart">
                                                                        <button data="<?php echo e($row->id); ?>" link="<?php echo e(route('site.cart.add')); ?>" class="button btn-cart" type="button">
                                                                            <span><i class="fa fa-shopping-cart"></i> <?php echo e(__('Thêm vào giỏ hàng')); ?> 
                                                                            </span>
                                                                        </button>
                                                                    </div>
                                                                </div>
                    ...
                    <div class="jtv-trending-products">
                        <div class="slider-items-products">
                            <div class="jtv-new-title">
                                <h2 style="font-family: Arial"><?php echo e(__('Sản phẩm khuyến mại')); ?></h2>
                            </div>
                            <div id="trending-slider" class="product-flexslider hidden-buttons">
                                <div class="slider-items slider-width-col4 products-grid">
                                    <?php $__currentLoopData = $product_disc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="item">
                                            <div class="item-inner">
                                                <div class="item-img">
                                                    <div class="item-img-info">
                                                        <a class="product-image" title="Xem chi tiết sản phẩm" href="<?php echo e(route('product.view', ['id' => $row->id])); ?>">
                                                            <img alt="Product tilte is here" src="<?php echo e(url(config('app.imageUrl'))); ?>/<?php echo e($row->avatar); ?>">
                                                        </a>
                                                        ...
                                                        <a value="<?php echo e($row->id); ?>" href="<?php echo e(route('site.cart.add_to_compare')); ?>" class="compare">
                                                            <div class="mask-right-shop">
                                                                <i class="fa fa-signal"></i>
                                                            </div>
                                                        </a>
                                                            ...
                                                            <div class="item-price">
                                                                <div class="price-box"><span class="regular-price"> <span class="price"><?php echo e(number_format($row->price - $row->discount, null, null, ".")); ?> VNĐ</span></span>
                                                                    <?php if($row->discount > 0): ?>
                                                                        <p class="old-price">
                                                                            <span class="price-label">Giá bán:</span>
                                                                            <span class="price"> <?php echo e(number_format($row->price, null, null, ".")); ?> VNĐ</span>
                                                                        </p>
                                                                    <?php endif; ?>
                                                                </div>
                                                            </div>
                                ...
                                <div class="blog-inner">
                                    <?php $__currentLoopData = $news; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="col-xs-12 col-sm-6 blog-preview_item">
                                            <div class="entry-thumb jtv-blog-img-hover"><a href="<?php echo e(route('site.news.view', ['id' => $row->id])); ?>"> <img alt="Xem tin tức" src="<?php echo e(url(config('app.newsUrl'))); ?>/<?php echo e($row->avatar); ?>"> </a></div>
                                            <h4 style="font-family:Arial" class="blog-preview_title"><a title="Xem tin tức" href="<?php echo e(route('site.news.view', ['id' => $row->id])); ?>"><?php echo e($row->title); ?></a></h4>
                                            <div class="blog-preview_info">
                                                ...
                                                <div style="font-family:Arial" class="blog-preview_desc news-content">
                ...
                <div class="top-sidebar col-left sidebar col-sm-4 col-xs-12 col-sm-pull-8 col-md-3 col-md-pull-9">
                    ...
                    <?php echo Form::open(['route' => 'site.home.search_mul', 'method' => 'get']); ?>
                        ...
                        <div style="font-family: Arial" class="form-group div-input">
                    ...
                    <div class="sidebar-banner"><img src="<?php echo e(asset('source/bower_components/library/site/version4/images/new-arrivals-banner.jpg')); ?>" alt="Sale"></div>
                    <?php if($product_view): ?>
                        <div class="jtv-hot-deal-product">
                            <ul class="products-grid">
                                <li class="right-space two-height item">
                                    <div class="item-inner">
                                        <div class="item-img">
                                            <div class="item-img-info"><a href="<?php echo e(route('product.view', ['id' => $product_view->id])); ?>" title="Đánh giá sản phẩm" class="product-image"><img src="<?php echo e(url(config('app.imageUrl'))); ?>/<?php echo e($product_view->avatar); ?>" alt=""> </a>
                                        ...
                                        <div class="item-info">
                                            <div class="info-inner">
                                                <div class="item-title"><a title="Xem chi tiết sản phẩm" href="<?php echo e(route('product.view', ['id' => $product_view->id])); ?>"><?php echo e($product_view->name); ?></a></div>
                                                <div class="item-content">
                                                    <div class="rating">
                                                        <?php for($i = 1;$i < 6;$i++): ?>
                                                    ...
                                                    <div class="actions">
                                                        <div class="add_cart">
                                                            <button data="<?php echo e($product_view->id); ?>" link="<?php echo e(route('site.cart.add')); ?>" class="button btn-cart" type="button"><span><i class="fa fa-shopping-cart"></i> Thêm vào giỏ hàng</span></button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                ...
                <!-- Top Seller Slider -->
                    <div class="jtv-top-products">
                        <div class="slider-items-products">
                            <div class="jtv-new-title">
                                <h2><?php echo e(__('Sản phẩm bán chạy')); ?></h2>
                            </div>
                                ...
                                <div class="slider-items slider-width-col4 products-grid">
                                    <?php $__currentLoopData = $product_sell; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="item">
                                            <div class="item-inner">
                                                <div class="item-img">
                                                    <div class="item-img-info"><a class="product-image" title="Xem chi tiết sản phẩm" href="<?php echo e(route('product.view', ['id' => $row->id])); ?>"> <img alt="Xem chi tiết sản phẩm" src="<?php echo e(url(config('app.imageUrl'))); ?>/<?php echo e($row->avatar); ?>"> </a>
            ...
            <div class="row">
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="support-policy"><i class="fa fa-truck"></i>
                        <div class="content" title="Giao hàng miễn phí"><?php echo e(__('Giao hàng miễn phí')); ?></div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="support-policy"><i class="fa fa-phone"></i>
                        <div class="content" title="Hỗ trợ khách hàng"><?php echo e(__('Hỗ trợ +84393 083 903')); ?></div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="support-policy"><i class="fa fa-refresh"></i>
                        <div class="content" title="30 ngày đổi trả"><?php echo e(__('30 ngày đổi trả')); ?></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="slider-items-products">
                <div id="jtv-brand-logo-slider" class="product-flexslider hidden-buttons">
                    <div class="slider-items slider-width-col6">
                        <div class="item">
                            <a>
                                <img src="<?php echo e(asset('source/bower_components/library/site/version4/images/dell.png')); ?>" alt="DELL" title="DELL">
                            </a>
                        </div>
                        <div class="item">
                            <a>
                                <img src="<?php echo e(asset('source/bower_components/library/site/version4/images/hp.png')); ?>" alt="HP" title="HP">
                            </a>
                        </div>
                        <div class="item">
                            <a>
                                <img src="<?php echo e(asset('source/bower_components/library/site/version4/images/apple.png')); ?>" alt="APPLE" title="APPLE">
                            </a>
                        </div>

                        <div class="item">
                            <a>
                                <img src="<?php echo e(asset('source/bower_components/library/site/version4/images/acer.png')); ?>" alt="ACER" title="ACER">
                            </a>
                        </div>
                        <div class="item">
                            <a>
                                <img src="<?php echo e(asset('source/bower_components/library/site/version4/images/lenovo.png')); ?>" alt="LENOVO" title="LENOVO">
                            </a>
                        </div>
                        <div class="item">
                            <a>
                                <img src="<?php echo e(asset('source/bower_components/library/site/version4/images/sony.jpg')); ?>" alt="SONY" title="SONY">
                            </a>
                        </div>
                    </div>
                </div>
