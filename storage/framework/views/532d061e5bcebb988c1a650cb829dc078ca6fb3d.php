...
<head>
    ...
    <title><?php echo e(__('Fabulous')); ?></title>
    <!-- Favicons Icon -->
...
<div id="jtv-mobile-menu">
    <ul>
                ...
                <?php echo Form::open(['route' => 'site.home.search', 'method' => 'get', 'id' => 'mob-search']); ?>
                    ...
                    <div class="input-group">
                        <div class="input-group-btn">
                            <?php echo Form::text('key', null, ['class' => 'form-control simple', 'placeholder' => 'Search ...', 'id' => 'srch-term', 'autocomplete' => 'off']); ?>
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <li class="nosub">
            <a href="<?php echo e(route('site.news.index')); ?>"><?php echo e(__('tin tức')); ?></a>
        </li>
        <li class="nosub">
            <a href="<?php echo e(route('site.contact.index')); ?>"><?php echo e(__('liên hệ')); ?></a>
        </li>
    </ul>
    <div class="top-links">
        <ul class="links">
            <?php if(Auth::check()): ?>
                <li>
                    <a title="My Account" href="<?php echo e(route('site.customer.edit', ['customer' => Auth::user()->id])); ?>"><?php echo e(Auth::user()->name); ?></a>
                </li>
                <li>
                    <a title="My Wishlist" href="<?php echo e(route('site.cart.view_to_wishlist')); ?>">Wishlist
                ...
                <li><a title="Logout" href="<?php echo e(route('site.customer.logout')); ?>">Log Out</a></li>
            <?php else: ?>
                <li><a title="Regester" href="<?php echo e(route('site.customer.regester')); ?>">Regester</a></li>
                <li><a title="Log In" href="<?php echo e(route('site.customer.login')); ?>">Log In</a></li>
            <?php endif; ?>
        </ul>
    </div>
</div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-sm-3 col-xs-12">
                        <!-- Header Logo -->
                        <div class="logo"><a title="ecommerce Template" href="<?php echo e(route('site.home.index')); ?>"><img alt="ecommerce Template" src="<?php echo e(asset('source/bower_components/library/site/version4/images/logo.png')); ?>"></a></div>
                        <!-- End Header Logo -->
                        <div class="nav-icon">
                            <div class="mega-container visible-lg visible-md visible-sm">
                                <div class="navleft-container">
                                    <div class="mega-menu-title">
                                        <h3><i class="fa fa-navicon"></i><?php echo e(__('Danh mục')); ?></h3>
                                    </div>
                        ...
                        <div class="jtv-header-box">
                            <div class="search_cart_block">
                                <div class="search-box hidden-xs">
                                    ...
                                    <?php echo Form::text('key', null, ['class' => 'searchbox search', 'placeholder' => 'Search', 'id' => 'search', 'autocomplete' => 'off']); ?>
                                ...
                                <div class="right_menu">
                                    <div class="menu_top">
                                        <div class="top-cart-contain pull-right" style="margin-left: 15px">
                                            <div class="mini-cart">
                                                <div class="basket"><a class="basket-icon" href="<?php echo e(route('site.cart.view_to_compare')); ?>"><i class="fa fa-balance-scale"></i> Compare <span class="badge" id="so-luong"><?php echo e($compare_sl > 0 ? $compare_sl : ""); ?></span></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="top-cart-contain pull-right">
                                            <div class="mini-cart" id="cart-content">
                                                <div class="basket"><a class="basket-icon"><i class="fa fa-shopping-basket"></i> Shopping Cart <span class="badge"><?php echo e(count($cart_init) > 0 ? count($cart_init) : ""); ?></span></a>
                                                        ...
                                                        <?php if(count($cart_init) > 0): ?>
                                                            ...
                                                            <ul class="mini-products-list" id="cart-sidebar">
                                                                <?php $__currentLoopData = $cart_init; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <li class="item">
                                                                        <div class="item-inner"><a class="product-image" title="product tilte is here" href="<?php echo e(route('product.view', ['id' => $row->id ])); ?>"><img alt="product tilte is here" src="<?php echo e(url(config('app.imageUrl'))); ?>/<?php echo e($row->options->avatar); ?>"></a>
                                ...
                                <div class="toplinks">
                                    ...
                                    <ul class="links">
                                        <?php if(Auth::check()): ?>
                                            ...
                                            <li>
                                                <a title="Logout" href="<?php echo e(route('site.customer.logout')); ?>">Log Out</a>
                                            </li>
                                        <?php else: ?>
                                            <li><a title="Regester" href="<?php echo e(route('site.customer.regester')); ?>">Regester</a></li>
                                            <li><a title="Log In" href="<?php echo e(route('site.customer.login')); ?>">Log In</a></li>
