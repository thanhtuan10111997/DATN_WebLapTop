            ...
            <div class="row">
                <div class="col-sm-8 col-sm-push-4 col-md-9 col-md-push-3 main-inner">
                        ...
                        <div class="jtv-featured-products">
                            <div class="slider-items-products">
                                <div class="jtv-new-title">
                                    <h2><?php echo e(__('Sản phẩm mới')); ?></h2>
                                </div>
                                                    ...
                                                    <div class="item-info">
                                                        <div class="info-inner">
                                                            <div class="item-title">
                                                                <a title="Product tilte is here" href="<?php echo e(route('product.view', ['id' => $row->id])); ?>"><?php echo e($row->name); ?></a>
                                                            </div>
                                                                ...
                                                                <div class="actions">
                                                                    <div class="add_cart">
                                                                        <button data="<?php echo e($row->id); ?>" link="<?php echo e(route('site.cart.add')); ?>" class="button btn-cart" type="button">
                                                                            <span><i class="fa fa-shopping-cart"></i> <?php echo e(__('Add to Cart')); ?> 
                                                                            </span>
                                                                        </button>
                                                                    </div>
                                                                </div>
                    ...
                    <div class="jtv-trending-products">
                        <div class="slider-items-products">
                            <div class="jtv-new-title">
                                <h2><?php echo e(__('Sản phẩm khuyến mại')); ?></h2>
                            </div>
                                    ...
                                    <?php $__currentLoopData = $product_disc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="item">
                                            <div class="item-inner">
                                                <div class="item-img">
                                                    <div class="item-img-info">
                                                        <a class="product-image" title="Product tilte is here" href="<?php echo e(route('product.view', ['id' => $row->id])); ?>">
                                                            <img alt="Product tilte is here" src="<?php echo e(url(config('app.imageUrl'))); ?>/<?php echo e($row->avatar); ?>">
                                                        </a>
                    ...
                    <div class="jtv-latest-blog">
                        <div class="jtv-new-title">
                            <h2><?php echo e(__('Tin tức mới nhất')); ?></h2>
                        </div>
                        <div class="row">
                                ...
                                <div class="blog-inner">
                                    <?php $__currentLoopData = $news; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="col-xs-12 col-sm-6 blog-preview_item">
                                            <div class="entry-thumb jtv-blog-img-hover"><a href="<?php echo e(route('site.news.view', ['id' => $row->id])); ?>"> <img alt="Blog" src="<?php echo e(url(config('app.newsUrl'))); ?>/<?php echo e($row->avatar); ?>"> </a></div>
                                            ...
                                            <div class="blog-preview_info">
                                                ...
                                                <a class="read_btn" href="<?php echo e(route('site.news.view', ['id' => $row->id])); ?>">Read More</a>
                                            </div>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                ...
                <div class="top-sidebar col-left sidebar col-sm-4 col-xs-12 col-sm-pull-8 col-md-3 col-md-pull-9">
                    ...
                    <?php echo Form::open(['route' => 'site.home.search_mul', 'method' => 'get']); ?>
                        ...
                        <div class="form-group div-input">
                            ...
                            <br><br>
                            <?php echo Form::submit(__('Tìm kiếm'), ['class' => 'btn btn-primary search-form']); ?>
                    ...
                    <div class="sidebar-banner"><img src="<?php echo e(asset('source/bower_components/library/site/version4/images/new-arrivals-banner.jpg')); ?>" alt="New Arrivals"></div>
                    <?php if($product_view): ?>
                        <div class="jtv-hot-deal-product">
                            <ul class="products-grid">
                                <li class="right-space two-height item">
                                    <div class="item-inner">
                                        <div class="item-img">
                                            <div class="item-img-info"><a href="<?php echo e(route('product.view', ['id' => $product_view->id])); ?>" title="Product tilte is here" class="product-image"><img src="<?php echo e(url(config('app.imageUrl'))); ?>/<?php echo e($product_view->avatar); ?>" alt="Product tilte is here"> </a>
                                        ...
                                        <div class="item-info">
                                            <div class="info-inner">
                                                <div class="item-title"><a title="Product tilte is here" href="<?php echo e(route('product.view', ['id' => $product_view->id])); ?>"><?php echo e($product_view->name); ?></a></div>
                                                <div class="item-content">
                                                    <div class="rating">
                                                        <?php for($i = 1;$i < 5;$i++): ?>
                                                    ...
                                                    <div class="actions">
                                                        <div class="add_cart">
                                                            <button data="<?php echo e($product_view->id); ?>" link="<?php echo e(route('site.cart.add')); ?>" class="button btn-cart" type="button"><span><i class="fa fa-shopping-cart"></i> Add to Cart</span></button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="item-info">
                                                    <div class="info-inner">
                                                        ...
                                                        <div class="item-content">
                                                            ...
                                                            <div class="actions">
                                                                <div class="add_cart">
                                                                    <button data="<?php echo e($row->id); ?>" link="<?php echo e(route('site.cart.add')); ?>" class="button btn-cart" type="button"><span><i class="fa fa-shopping-cart"></i> Add to Cart</span></button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
            ...
            <div class="row">
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="support-policy"><i class="fa fa-truck"></i>
                        <div class="content"><?php echo e(__('Free Shipping on order over $49')); ?></div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="support-policy"><i class="fa fa-phone"></i>
                        <div class="content"><?php echo e(__('Need Help +1 123 456 7890')); ?></div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="support-policy"><i class="fa fa-refresh"></i>
                        <div class="content"><?php echo e(__('30 days return Service')); ?></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="slider-items-products">
                <div id="jtv-brand-logo-slider" class="product-flexslider hidden-buttons">
                    <div class="slider-items slider-width-col6">
                        <div class="item">
                            <a>
                                <img src="<?php echo e(asset('source/bower_components/library/site/version4/images/brand1.png')); ?>" alt="Brand Logo">
                            </a>
                        </div>
                        <div class="item">
                            <a>
                                <img src="<?php echo e(asset('source/bower_components/library/site/version4/images/brand2.png')); ?>" alt="Brand Logo">
                            </a>
                        </div>
                        <div class="item">
                            <a>
                                <img src="<?php echo e(asset('source/bower_components/library/site/version4/images/brand3.png')); ?>" alt="Brand Logo">
                            </a>
                        </div>
                        <div class="item">
                            <a>
                                <img src="<?php echo e(asset('source/bower_components/library/site/version4/images/brand4.png')); ?>" alt="Brand Logo">
                            </a>
                        </div>
                        <div class="item">
                            <a>
                                <img src="<?php echo e(asset('source/bower_components/library/site/version4/images/brand5.png')); ?>" alt="Brand Logo">
                            </a>
                        </div>
                        <div class="item">
                            <a>
                                <img src="<?php echo e(asset('source/bower_components/library/site/version4/images/brand6.png')); ?>" alt="Brand Logo">
                            </a>
                        </div>
                        <div class="item">
                            <a>
                                <img src="<?php echo e(asset('source/bower_components/library/site/version4/images/brand7.png')); ?>" alt="Brand Logo">
                            </a>
                        </div>
                        <div class="item">
                            <a>
                                <img src="<?php echo e(asset('source/bower_components/library/site/version4/images/brand8.png')); ?>" alt="Brand Logo">
                            </a>
                        </div>
                    </div>
                </div>
