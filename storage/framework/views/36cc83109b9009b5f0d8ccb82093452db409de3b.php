            ...
            <fieldset>
                <div class="widget">
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            <?php echo Form::select('parent_id', $type_category, null, ['required', 'placeholder' => 'Chọn một danh mục']); ?>
