            ...
            <div class="row">
                <div class="col-xs-12">
                    <ul>
                        ...
                        <li><a href="<?php echo e(route('site.category.index', ['id' => $product->category->id])); ?>" title=""><?php echo e($product->category->name); ?></a> <span>/ </span></li>
            ...
            <div class="row">
                    ...
                    <div class="product-essential">
                        ...
                        <div class="product-shop col-lg-8 col-sm-7 col-xs-12">
                            ...
                            <div class="rating">
                                ...
                                <?php if($total > 0): ?>
                                    <span class="review-no"><?php echo e($total); ?> user reviews</span>
                                <?php else: ?>
                                    <span class="review-no"><?php echo e(__('Hãy là người đầu tiên đánh giá sản phẩm')); ?></span>
                                <?php endif; ?>
                                <input type="hidden" name="id" required value="<?php echo e($product->id); ?>">
                                <br/>
                                <button id="reviews" class="btn btn-success"><?php echo e(__('Submit Review')); ?>
                            ...
                            <div class="price-block">
                                <div class="price-box">
                                    <div>
                                        <h3 class="prices"><?php echo e(__('Giá bán')); ?></h3>
                                    </div>
                                    ...
                                    <?php endif; ?>
                                    <p class="availability in-stock"><span><?php echo e(__('In Stock')); ?></span></p>
                                </div>
                            </div>
                            <div class="add-to-box" style="width: 99%">
                                <div class="add-to-cart">
                                    ...
                                    <button data="<?php echo e($product->id); ?>" link="<?php echo e(route('site.cart.add')); ?>" class="button btn-cart multiple" title="Add to Cart" type="button">
                                        <i class="fa fa-shopping-cart"></i> <?php echo e(__('Add to Cart')); ?>
                                    ...
                                    <ul class="add-to-links">
                                        <li>
                                            <a class="link-wishlist wishlist" value="<?php echo e($product->id); ?>" href="<?php echo e(route('site.cart.add_to_wishlist')); ?>"><i class="fa fa-heart"></i>
                                                <span><?php echo e(__('Add to Wishlist')); ?></span>
                                            </a>
                                        </li>
                                        <li>
                                            <a class="link-compare compare" value="<?php echo e($product->id); ?>" href="<?php echo e(route('site.cart.add_to_compare')); ?>"><i class="fa fa-signal"></i>
                                                <span><?php echo e(__('Add to Compare')); ?></span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                ...
                <div class="product-collateral col-lg-12 col-sm-12 col-xs-12">
                    <ul id="product-detail-tab" class="nav nav-tabs product-tabs">
                        ...
                        <li><a href="#product_tabs_tags" data-toggle="tab"><?php echo e(__('Thông số')); ?></a></li>
                                    ...
                                    <form id="addTagForm" action="#" method="get">
                                        <div class="form-add-tags">
                                            <table class="table table-condensed" style="width: 50%;">
                                                ...
                                                <tr>
                                                    <th class="col-lg-1 table-product"><?php echo e(__('Camera sau:')); ?></th>
                                                    <td class="col-lg-5 table-product"><?php echo e($product->configuration->back_camera); ?></td>

                                                </tr>
                                                <tr>
                                                    <th class="col-lg-1 table-product"><?php echo e(__('Camera trước:')); ?></th>
                                                ...
                                                <tr>
                                                    <th class="col-lg-1 table-product"><?php echo e(__('Bộ nhớ trong:')); ?></th>
                                                    <td class="col-lg-5 table-product"><?php echo e($product->configuration->memory); ?></td>
                                                </tr>
                                                <tr>
                                                    <th class="col-lg-1 table-product"><?php echo e(__('Dung lượng pin:')); ?></th>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-8">
                                    <div class="card">
                                        <div class="card-body">
                                            <br/>
                                            <h4><?php echo e(__('Add comment')); ?></h4>
                                            <div>
                                                <div class="form-group">
                                                    <textarea type="text" rows="5" name="comment_body" class="form-control"></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <input id="add-comment" type="submit" post="<?php echo e($product->id); ?>" class="btn btn-warning" value="Post"/>
                                                </div>
                                            </div>
                                            <?php if($product->comments->count() > 0): ?>
                                                <div class="title"><h4><?php echo e(count($product->comments)); ?> <?php echo e(__('Comment')); ?> </h4></div>
                                            <?php else: ?>
        ...
        <div class="jtv-related-products">
            <div class="slider-items-products">
                <div class="jtv-new-title">
                    <h2><?php echo e(__('Sản phẩm cùng loại')); ?></h2>
                </div>
