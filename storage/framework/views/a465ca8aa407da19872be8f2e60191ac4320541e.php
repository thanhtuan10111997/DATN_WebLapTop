<?php $__env->startSection('content'); ?>
   <?php echo $__env->make('admin.customer.head', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    ...
    <div class="wrapper">
        <!-- Form -->
        <?php echo Form::open(['route' => ['customer.update', $customer->id], 'method' => 'PUT', 'class' => 'form']); ?>

            <fieldset>
                <div class="widget">
                    <div class="title">
                        <img src="<?php echo e(asset('source/bower_components/library/backend/admin/images/icons/dark/add.png')); ?>" class="titleIcon" />
                        <h6><?php echo e(__('Cập nhật thông tin khách hàng')); ?></h6>
                    </div>
                    <div class="formRow">   
                        ...
                        <div class="formRight">
                            <span class="oneTwo">
                                <?php echo Form::text('name', $customer->name, ['required', 'autocomplete' => 'off']); ?>
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            <span class="oneTwo">
                                <?php echo Form::email('email', $customer->email, ['disabled', 'autocomplete' => 'off']); ?>
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            <span class="oneTwo">
                                <?php echo Form::text('phone', $customer->phone, ['required', 'autocomplete' => 'off']); ?>
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            <?php echo Form::select('address_id', $addresses, "$customer->address_id", ['class' => 'address']); ?>
