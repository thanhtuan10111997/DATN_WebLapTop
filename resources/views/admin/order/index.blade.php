                ...
                <ul>
                    ...
                    <li>
                        <a href="{{ route('order.export_to_excel') }}">
                            ...
                            <span class="export">{{ __('Xuất dữ liệu') }}</span>
                        </a>
                    </li>
                </ul>
            </div>
            ...
            @if (isset($order) && count($order) > 0)
                ...
                <table cellpadding="0" cellspacing="0" width="100%" class="sTable mTable myTable" id="checkAll">
                    ...
                    <tr>
                        ...
                        <td style="width:60 !important;">{{ __('Đơn giá sản phẩm') }}</td>
                        <td>{{ __('Trạng thái') }}</td>
                        <td>{{ __('Ngày tạo') }}</td>
                        <td>{{ __('Hành động') }}</td>
                    </tr>
                    ...
                    @foreach ($order as $row)
                        <tr class='row_{{ $row->id }}'>
                            ...
                            <td style="width:60 !important;" class="textC red">{{ number_format($row->amount) }} đ</td>
