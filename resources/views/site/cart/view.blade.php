    ...
    <div style="font-family:Arial" class="breadcrumbs">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <ul>
                        <li class="home"><a href="{{ route('site.home.index') }}" title="Đi đến Trang chủ">{{ __('Trang Chủ') }}</a> <span>/</span></li>
                        ...
                        <div class="title-tab-product-category">
                            <div class="text-center">
                                <ul class="nav jtv-heading-style" role="tablist">
                                    <li role="presentation" class="active"><a href="#cart" aria-controls="cart" role="tab" data-toggle="tab">{{ __('1. Giỏ Hàng Của Tôi') }}</a></li>
                                    <li role="presentation"><a href="#checkout" aria-controls="checkout" role="tab" data-toggle="tab">{{ __('2. Kiểm Tra Thông Tin') }}</a></li>
                                    <li role="presentation" class=""><a href="#complete-order" aria-controls="complete-order" role="tab" data-toggle="tab">{{ __('3. Kiểm Tra Đặt Hàng') }}</a></li>
                                </ul>
                            </div>
                        </div>
                        <br>
                                                ...
                                                <table class="shop-cart-table data-cart" id="checkAll">
                                                    ...
                                                    @foreach($cart as $row)
                                                        <tr class="cart_item row-{{ $row->id }}">
                                                            ...
                                                            <td class="item-price" style="width:180px">{{ number_format($row->price, null, null, ".") }} đ</td>
                                                            <td class="item-qty">
