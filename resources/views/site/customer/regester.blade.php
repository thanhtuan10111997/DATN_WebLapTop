        ...
        <div class="main container">
            ...
            <div class="account-login">
                <div class="page-title">
                    <h2 style="font-family:Arial">{{ __('Đăng Ký Tài Khoản') }}</h2>
                </div>
                ...
                <fieldset>
                    <div class="registered-users">
                        <div class="content">
                            ...
                            <p class="required">{{ __('(*) Trường bắt buộc') }}</p>
                            <div class="buttons-set">
                                {{ Form::submit('ĐĂNG KÝ', ['class' => 'button login']) }}
                                <a class="forgot-word" href="{{ route('site.customer.login') }}">{{ __("Bạn đã có tài khoản?") }}</a></div>
                        </div>
                    </div>
                </fieldset>
                {!! Form::close() !!}
