        ...
        <div class="container">
            <div class="row">
                                        ...
                                        @foreach($product as $row)
                                            <div class="item">
                                                <div class="item-inner">
                                                    <div class="item-img">
                                                        <div class="item-img-info"><a class="product-image" title="" href="product-detail.html"> <img alt="" src="{{ url(config('app.imageUrl')) }}/{{ $row->avatar }}"> </a>
                                                    ...
                                                    <div class="item-info">
                                                        <div class="info-inner">
                                                            <div class="item-title">
                                                                <a title="" href="{{ route('product.view', ['id' => $row->id]) }}">{{ $row->name }}</a>
                                                            </div>
                                ...
                                <div class="blog-inner">
                                    @foreach($news as $row)
                                        <div class="col-xs-12 col-sm-6 blog-preview_item">
                                            <div class="entry-thumb jtv-blog-img-hover"><a href="{{ route('site.news.view', ['id' => $row->id]) }}"> <img alt="" src="{{ url(config('app.newsUrl')) }}/{{ $row->avatar }}"> </a></div>
                ...
                <div class="top-sidebar col-left sidebar col-sm-4 col-xs-12 col-sm-pull-8 col-md-3 col-md-pull-9">
                    ...
                    <div class="sidebar-banner"><img src="{{ asset('source/bower_components/library/site/version4/images/new-arrivals-banner.jpg') }}" alt=""></div>
                    <div class="jtv-hot-deal-product">
                        <ul class="products-grid">
                            <li class="right-space two-height item">
                                <div class="item-inner">
                                    <div class="item-img">
                                        <div class="item-img-info"><a href="{{ route('product.view', ['id' => $product_view->id]) }}" title="" class="product-image"><img src="{{ url(config('app.imageUrl')) }}/{{ $product_view->avatar }}" alt=""> </a>
                                    ...
                                    <div class="item-info">
                                        <div class="info-inner">
                                            <div class="item-title"><a title="" href="{{ route('product.view', ['id' => $product_view->id]) }}">{{ $product_view->name }}</a></div>
                                            <div class="item-content">
            ...
            <div class="row">
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="support-policy"><i class="fa fa-truck"></i>
                        <div class="content">{{ __('Miễn phí vận chuyển') }}</div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="support-policy"><i class="fa fa-phone"></i>
                        <div class="content">{{ __('Hỗ trợ: +84393 083 903') }}</div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="support-policy"><i class="fa fa-refresh"></i>
                        <div class="content">{{ __('30 ngày đổi trả') }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="slider-items-products">
                <div id="jtv-brand-logo-slider" class="product-flexslider hidden-buttons">
                    <div class="slider-items slider-width-col6">
                        <div class="item">
                            <a>
                                <img src="{{ asset('source/bower_components/library/site/version4/images/brand1.png') }}" alt="">
                            </a>
                        </div>
                        <div class="item">
                            <a>
                                <img src="{{ asset('source/bower_components/library/site/version4/images/brand2.png') }}" alt="">
                            </a>
                        </div>
                        <div class="item">
                            <a>
                                <img src="{{ asset('source/bower_components/library/site/version4/images/brand3.png') }}" alt="">
                            </a>
                        </div>
                        <div class="item">
                            <a>
                                <img src="{{ asset('source/bower_components/library/site/version4/images/brand4.png') }}" alt="">
                            </a>
                        </div>
                        <div class="item">
                            <a>
                                <img src="{{ asset('source/bower_components/library/site/version4/images/brand5.png') }}" alt="">
                            </a>
                        </div>
                        <div class="item">
                            <a>
                                <img src="{{ asset('source/bower_components/library/site/version4/images/brand6.png') }}" alt="">
                            </a>
                        </div>
                        <div class="item">
                            <a>
                                <img src="{{ asset('source/bower_components/library/site/version4/images/brand7.png') }}" alt="">
                            </a>
                        </div>
                        <div class="item">
                            <a>
                                <img src="{{ asset('source/bower_components/library/site/version4/images/brand8.png') }}" alt="">
                            </a>
                        </div>
                    </div>
                </div>
