            ...
            <div class="row">
                <div class="col-sm-8 col-sm-push-4 col-md-9 col-md-push-3 main-inner">
                        ...
                        <div class="jtv-featured-products">
                            <div class="slider-items-products">
                                <div class="jtv-new-title">
                                    <h2 style="font-family: Arial">{{ __('Sản phẩm mới') }}</h2>
                                </div>
                                                    ...
                                                    <div class="item-info">
                                                        <div class="info-inner">
                                                            <div class="item-title">
                                                                <a title="Xem chi tiết sản phẩm" href="{{ route('product.view', ['id' => $row->id]) }}">{{ $row->name }}</a>
                                                            </div>
                                                                ...
                                                                <div class="actions">
                                                                    <div class="add_cart">
                                                                        <button data="{{ $row->id }}" link="{{ route('site.cart.add') }}" class="button btn-cart" type="button">
                                                                            <span><i class="fa fa-shopping-cart"></i> {{ __('Thêm vào giỏ hàng') }} 
                                                                            </span>
                                                                        </button>
                                                                    </div>
                                                                </div>
                    ...
                    <div class="jtv-trending-products">
                        <div class="slider-items-products">
                            <div class="jtv-new-title">
                                <h2 style="font-family: Arial">{{ __('Sản phẩm khuyến mại') }}</h2>
                            </div>
                                    ...
                                    @foreach($product_disc as $row)
                                        <div class="item">
                                            <div class="item-inner">
                                                <div class="item-img">
                                                    <div class="item-img-info">
                                                        <a class="product-image" title="Xem chi tiết sản phẩm" href="{{ route('product.view', ['id' => $row->id]) }}">
                                                            ...
                                                            <div class="item-price">
                                                                <div class="price-box"><span class="regular-price"> <span class="price">{{ number_format($row->price - $row->discount, null, null, ".") }} VNĐ</span></span>
                                                                    @if($row->discount > 0)
                                                                        <p class="old-price">
                                                                            <span class="price-label">Giá bán:</span>
                                                                            <span class="price"> {{ number_format($row->price, null, null, ".") }} VNĐ</span>
                                                                        </p>
                                                                    @endif
                                                                </div>
                                                            </div>
                    ...
                    <div class="jtv-latest-blog">
                        <div class="jtv-new-title">
                            <h2 style="font-family: Arial">{{ __('Tin tức mới nhất') }}</h2>
                        </div>
                        <div class="row">
                                ...
                                <div class="blog-inner">
                                    @foreach($news as $row)
                                        <div class="col-xs-12 col-sm-6 blog-preview_item">
                                            <div class="entry-thumb jtv-blog-img-hover"><a href="{{ route('site.news.view', ['id' => $row->id]) }}"> <img alt="Xem tin tức" src="{{ url(config('app.newsUrl')) }}/{{ $row->avatar }}"> </a></div>
                                            <h4 style="font-family:Arial" class="blog-preview_title"><a title="Xem tin tức" href="{{ route('site.news.view', ['id' => $row->id]) }}">{{ $row->title }}</a></h4>
                                            <div class="blog-preview_info">
                                                ...
                                                <a style="font-family:Arial" class="read_btn" href="{{ route('site.news.view', ['id' => $row->id]) }}">Đọc thêm...</a>
                                            </div>
                                        </div>
                                    @endforeach
                                </div>
                ...
                <div class="top-sidebar col-left sidebar col-sm-4 col-xs-12 col-sm-pull-8 col-md-3 col-md-pull-9">
                    ...
                    {!! Form::open(['route' => 'site.home.search_mul', 'method' => 'get']) !!}
                        <div style="font-family: Arial" class="form-group div-input">
                            ...
                            <br><br>
                            {!! Form::submit(__('Tìm kiếm nâng cao'), ['class' => 'btn btn-primary search-form']) !!}
                        </div>
                    {!! Form::close() !!}
                    </div>
                  
                    <div class="sidebar-banner"><img src="{{ asset('source/bower_components/library/site/version4/images/new-arrivals-banner.jpg') }}" alt="Sale"></div>
                    @if($product_view)
                        <div class="jtv-hot-deal-product">
                            <ul class="products-grid">
                                <li class="right-space two-height item">
                                    <div class="item-inner">
                                        <div class="item-img">
                                            <div class="item-img-info"><a href="{{ route('product.view', ['id' => $product_view->id]) }}" title="Đánh giá sản phẩm" class="product-image"><img src="{{ url(config('app.imageUrl')) }}/{{ $product_view->avatar }}" alt=""> </a>
                                        ...
                                        <div class="item-info">
                                            <div class="info-inner">
                                                <div class="item-title"><a title="Xem chi tiết sản phẩm" href="{{ route('product.view', ['id' => $product_view->id]) }}">{{ $product_view->name }}</a></div>
                                                <div class="item-content">
                                                    <div class="rating">
                                                        @for($i = 1;$i < 6;$i++)
                                                    ...
                                                    <div class="actions">
                                                        <div class="add_cart">
                                                            <button data="{{ $product_view->id }}" link="{{ route('site.cart.add') }}" class="button btn-cart" type="button"><span><i class="fa fa-shopping-cart"></i> Thêm vào giỏ hàng</span></button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="slider-items slider-width-col4 products-grid">
                                    @foreach($product_sell as $row)
                                        <div class="item">
                                            <div class="item-inner">
                                                <div class="item-img">
                                                    <div class="item-img-info"><a class="product-image" title="Xem chi tiết sản phẩm" href="{{ route('product.view', ['id' => $row->id]) }}"> <img alt="Xem chi tiết sản phẩm" src="{{ url(config('app.imageUrl')) }}/{{ $row->avatar }}"> </a>
            ...
            <div class="row">
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="support-policy"><i class="fa fa-truck"></i>
                        <div class="content" title="Giao hàng miễn phí">{{ __('Giao hàng miễn phí') }}</div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="support-policy"><i class="fa fa-phone"></i>
                        <div class="content" title="Hỗ trợ khách hàng">{{ __('Hỗ trợ +84393 083 903') }}</div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="support-policy"><i class="fa fa-refresh"></i>
                        <div class="content" title="30 ngày đổi trả">{{ __('30 ngày đổi trả') }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="slider-items-products">
                <div id="jtv-brand-logo-slider" class="product-flexslider hidden-buttons">
                    <div class="slider-items slider-width-col6">
                        <div class="item">
                            <a>
                                <img src="{{ asset('source/bower_components/library/site/version4/images/dell.png') }}" alt="DELL" title="DELL">
                            </a>
                        </div>
                        <div class="item">
                            <a>
                                <img src="{{ asset('source/bower_components/library/site/version4/images/hp.png') }}" alt="HP" title="HP">
                            </a>
                        </div>
                        <div class="item">
                            <a>
                                <img src="{{ asset('source/bower_components/library/site/version4/images/apple.png') }}" alt="APPLE" title="APPLE">
                            </a>
                        </div>

                        <div class="item">
                            <a>
                                <img src="{{ asset('source/bower_components/library/site/version4/images/acer.png') }}" alt="ACER" title="ACER">
                            </a>
                        </div>
                        <div class="item">
                            <a>
                                <img src="{{ asset('source/bower_components/library/site/version4/images/lenovo.png') }}" alt="LENOVO" title="LENOVO">
                            </a>
                        </div>
                        <div class="item">
                            <a>
                                <img src="{{ asset('source/bower_components/library/site/version4/images/sony.jpg') }}" alt="SONY" title="SONY">
                            </a>
                        </div>
                    </div>
                </div>
...
@endsection
@section('script')
    <script type="text/javascript" src="{{ asset('source/bower_components/library/site/version4/js/slide-show.js') }}"></script>
@endsection