    ...
    <div style="font-family:Arial" class="breadcrumbs">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <ul>
                        <li style="font-family:Arial" class="home"><a title="Đi đến Trang chủ" href="index.html">{{ __('Trang Chủ') }}</a> <span>/</span></li>
                        <li><strong style="font-family:Arial">{{ __('Giới Thiệu') }}</strong></li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-main">
                        <div class="static-inner">
                            ...
                            <div class="page-title">
                                <h2 style="font-family:Arial">{{ __('Giới Thiệu') }}</h2>
                            </div>
                            <div class="static-contain" style="margin-left:250px">
                                ...
                                <h4>
                                    <img class="img-responsive" style="display:block; margin-left:auto; margin-right: auto" src="{{ asset('source/bower_components/library/site/version4/images/camket.png') }}"
                                </h4>
                                ...
                                <h4>
                                    <img class="img-responsive" style="display:block; margin-left:auto; margin-right: auto" src="{{ asset('source/bower_components/library/site/version4/images/logo_hang.png') }}"  
                                ...
                                <h4>
                                    <img class="img-responsive" style="display:block; margin-left:auto; margin-right: auto" src="{{ asset('source/bower_components/library/site/version4/images/cuahang.png') }}">
                                </h4><br />
